...
namespace PetsHome.UI.Controllers
{
    ...
    public class MascotaController : BaseController
    {
        ...
        public MascotaController(MascotaService mascotaService, RefugioService refugioService, IOptions<MascotaViewModel> options)
        {
        ...
        public async Task<IActionResult> Add(MascotaViewModel model)
        {
            ...
            if (!model.isEdit)
            {
                Boolean createdItem = await _mascotaService.AddAsync(model, userId);
            ...
            {
                Boolean updatedItem = await _mascotaService.UpdateAsync(model, userId);

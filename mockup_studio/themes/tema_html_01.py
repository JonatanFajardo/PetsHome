"""
tema_html_01.py — Lee tema_html_01.html, inyecta datos y toma screenshot con Playwright.
Para editar el diseño: abre tema_html_01.html directamente en VS Code o el browser.
"""
...
class Tema(BaseTheme):
    ...
    def componer(self, screenshots, config, indice, output_path: Path):
        ...
        # Seleccionar 3 screenshots para este índice
        imgs = [_to_b64(screenshots[(indice * 2 + i) % n]) for i in range(3)]

        # Leer template e inyectar placeholders
        ...
        # Guardar HTML temporal y tomar screenshot

...
namespace PetsHome.Logic.Repositories
{
    public class EmpleadosCargoRepository : IGenericRepository<tbEmpleadosCargos>
    {
        ...
        public async Task<RequestResult> AddAsync(tbEmpleadosCargos entity)
        {
        ...
        public async Task<RequestResult> EditAsync(tbEmpleadosCargos entity)
        {
        ...
        {
            const string sqlQuery = "[Refugio].[PR_Refugio_EmpleadosCargos_Delete]";
            var parameter = new DynamicParameters();
            parameter.Add("@cag_Id", id, DbType.Int32, ParameterDirection.Input);
            return await DbApp.ExecuteWithResult(sqlQuery, parameter);
        }
        ...
        {
            const string sqlQuery = "[Refugio].[PR_Refugio_EmpleadosCargos_Existe]";
            var parameter = new DynamicParameters();
            parameter.Add("@cag_Descripcion", descripcion, DbType.String, ParameterDirection.Input);
            parameter.Add("@cag_Id", id, DbType.Int32, ParameterDirection.Input);

...
{
    public class SolicitudRepository : IGenericRepository<tbSolicitudes>
    {
        ...
        public async Task<RequestResult> AddAsync(tbSolicitudes entity)
        {
        ...
        public async Task<RequestResult> EditAsync(tbSolicitudes entity)
        {
            ...
            parameter.Add("@sol_Fecha", entity.sol_Fecha, DbType.DateTime, ParameterDirection.Input);
            parameter.Add("@masc_Id", entity.masc_Id, DbType.Int32, ParameterDirection.Input);
            parameter.Add("@sol_UsuarioModifica", entity.sol_UsuarioModifica, DbType.Int32, ParameterDirection.Input);
            return await DbApp.ExecuteWithResult(sqlQuery, parameter);
        }

        public async Task<RequestResult> RemoveAsync(int id)
        {
            const string sqlQuery = "[Refugio].[PR_Refugio_Solicitudes_Delete]";
            var parameter = new DynamicParameters();
            parameter.Add("@sol_Id", id, DbType.Int32, ParameterDirection.Input);
            return await DbApp.ExecuteWithResult(sqlQuery, parameter);
        }

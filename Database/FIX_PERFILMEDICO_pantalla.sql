-- ============================================================
-- FIX: Registrar pantalla "Perfil medico de mascota"
...
IF NOT EXISTS (
    ...
    WHERE pan_Descripcion = 'Perfil medico de mascota'
)
BEGIN
    INSERT INTO [Seguridad].[tbPantallas] (pan_Descripcion, pan_Grupo, pan_EsActivo)
    VALUES ('Perfil medico de mascota', 'Medicamento', 1)
    PRINT 'Pantalla creada: Perfil medico de mascota'
END
ELSE
...
WHERE p.pan_Descripcion = 'Perfil medico de mascota'
  AND NOT EXISTS (

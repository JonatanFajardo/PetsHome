-- ============================================================
-- FIX: Registrar pantalla "Control de vacunacion"
...
IF NOT EXISTS (
    ...
    WHERE pan_Descripcion = 'Control de vacunacion'
)
BEGIN
    INSERT INTO [Seguridad].[tbPantallas] (pan_Descripcion, pan_Grupo, pan_EsActivo)
    VALUES ('Control de vacunacion', 'Medicamento', 1)
    PRINT 'Pantalla creada: Control de vacunacion'
END
ELSE
...
WHERE p.pan_Descripcion = 'Control de vacunacion'
  AND NOT EXISTS (

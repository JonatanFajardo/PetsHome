-- ============================================================
-- FIX: Registrar pantalla "Dashboard veterinario"
...
IF NOT EXISTS (
    ...
    WHERE pan_Descripcion = 'Dashboard veterinario'
)
BEGIN
    INSERT INTO [Seguridad].[tbPantallas] (pan_Descripcion, pan_Grupo, pan_EsActivo)
    VALUES ('Dashboard veterinario', 'Medicamento', 1)
    PRINT 'Pantalla creada: Dashboard veterinario'
END
ELSE
...
WHERE p.pan_Descripcion = 'Dashboard veterinario'
  AND NOT EXISTS (

-- ============================================================
-- FIX: Registrar pantalla "Reporte de adopciones"
...
IF NOT EXISTS (
    ...
    WHERE pan_Descripcion = 'Reporte de adopciones'
)
BEGIN
    INSERT INTO [Seguridad].[tbPantallas] (pan_Descripcion, pan_Grupo, pan_EsActivo)
    VALUES ('Reporte de adopciones', 'Adopcion', 1)
    PRINT 'Pantalla creada: Reporte de adopciones'
END
ELSE
...
WHERE p.pan_Descripcion = 'Reporte de adopciones'
  AND NOT EXISTS (

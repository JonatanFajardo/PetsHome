...
namespace PetsHome.Business.Models
{
    ...
    /// </summary>
    public partial class CitaMedicaFormViewModel
    {
        ...
        /// </summary>
        /// <param name="comportamientoViewModels">Resultados de la lista desplegable de comportamientos.</param>
        /// <param name="vacunaViewModel">Resultados de la lista desplegable de vacunas.</param>
        ...
        {
            comportamientoList = new SelectList(comportamientoViewModels ?? new List<ComportamientoViewModel>(), "Com_Id", "Com_Descripcion");
            VacunaList = new SelectList(vacunaViewModel ?? new List<VacunaDropdownViewModel>(), "vac_Id", "vac_Descripcion");
        }

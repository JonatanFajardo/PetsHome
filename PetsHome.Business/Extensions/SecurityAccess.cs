namespace PetsHome.Business.Extensions
{
    public class SecurityAccess
    {
        ...
        public const string ListHistorialMedico_Vacunas = "Listado_HistorialMedico_Vacunas";
        public const string InsertHistorialMedico_Vacunas = "Registro_HistorialMedico_Vacunas";
        public const string EditHistorialMedico_Vacunas = "Modificar_HistorialMedico_Vacunas";
        public const string DeleteHistorialMedico_Vacunas = "Eliminar_HistorialMedico_Vacunas";

        public const string ListProcedencias = "Listado_Procedencias";
        public const string InsertProcedencias = "Registro_Procedencias";
        public const string EditProcedencias = "Modificar_Procedencias";
        public const string DeleteProcedencias = "Eliminar_Procedencias";

        public const string ListRazas = "Listado_Razas";
        public const string InsertRazas = "Registro_Razas";
        public const string EditRazas = "Modificar_Razas";
        public const string DeleteRazas = "Eliminar_Razas";

        public const string ListSolicitudes = "Listado_Solicitudes";
        public const string InsertSolicitudes = "Registro_Solicitudes";
        public const string EditSolicitudes = "Modificar_Solicitudes";
        public const string DeleteSolicitudes = "Eliminar_Solicitudes";

        public const string ListVacunas = "Listado_Vacunas";
        public const string InsertVacunas = "Registro_Vacunas";
        public const string EditVacunas = "Modificar_Vacunas";
        public const string DeleteVacunas = "Eliminar_Vacunas";

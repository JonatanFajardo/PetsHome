...
namespace PetsHome.Business.Extensions
{
    ...
    public class MappingProfileExtensions : Profile
    {
        ...
        public MappingProfileExtensions()
        {
            ...
            CreateMap<PR_Refugio_Empleados_DetailResult, EmpleadoDetailViewModel>().ReverseMap();
            ...
            CreateMap<PR_Refugio_CitaMedica_DetailResult, CitaMedicaDetailViewModel>().ReverseMap();
            CreateMap<PR_Refugio_CitaMedica_FindResult, CitaMedicaViewModel>().ReverseMap();
            CreateMap<PR_Refugio_CitaMedica_ListResult, CitaMedicaViewModel>().ReverseMap();
            CreateMap<PR_Refugio_Mascotas_DetailResult, MascotaDetailViewModel>().ReverseMap();
            ...
            CreateMap<PR_Refugio_Voluntarios_DetailResult, VoluntarioDetailViewModel>().ReverseMap();
            ...
            CreateMap<tbCitaMedica, CitaMedicaViewModel>().ReverseMap();
            CreateMap<PR_Refugio_Donaciones_DetailResult, DonacionViewModel>().ReverseMap();
            CreateMap<PR_Refugio_Donaciones_FindResult, DonacionViewModel>().ReverseMap();

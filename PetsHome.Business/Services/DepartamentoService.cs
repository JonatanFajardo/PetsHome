...
namespace PetsHome.Business.Services
{
    ...
    public class DepartamentoService
    {
        ...
        /// </summary>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene la lista de departamentos.</returns>
        ...
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene el departamento encontrado.</returns>
        ...
        /// </summary>
        /// <param name="id">El ID del departamento.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene los detalles del departamento.</returns>
        ...
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se agreg� el departamento correctamente.</returns>
        public async Task<Boolean> AddAsync(DepartamentoViewModel model, int userId)
        {
            try
            {
        ...
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se actualiz� el departamento correctamente.</returns>
        public async Task<Boolean> UpdateAsync(DepartamentoViewModel model, int userId)
        {
            try
            {
                tbDepartamentos mappedResult = _mapper.Map<tbDepartamentos>(model);
        ...
        /// </summary>
        /// <returns>Una enumeraci�n de DepartamentoViewModel que representa el dropdown de departamentos.</returns>

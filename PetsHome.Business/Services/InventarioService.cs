...
namespace PetsHome.Business.Services
{
    ...
    public class InventarioService
    {
        ...
        /// <returns>True si el registro del inventario se agreg� correctamente, False si ocurri� un error.</returns>
        public async Task<bool> AddAsync(InventarioViewModel model, int userId)
        {
            try
            {
        ...
        /// <returns>True si el registro del inventario se actualiz� correctamente, False si ocurri� un error.</returns>
        public async Task<bool> UpdateAsync(InventarioViewModel model, int userId)
        {
            try
            {
                tbInventarios mappedResult = _mapper.Map<tbInventarios>(model);
        ...
        /// <returns>True si el registro del inventario se elimin� correctamente, False si ocurri� un error.</returns>

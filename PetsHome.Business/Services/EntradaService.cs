...
namespace PetsHome.Business.Services
{
    ...
    public class EntradaService
    {
        ...
        /// <summary>
        /// Obtiene una lista de Entradas de forma as�ncrona.
        /// </summary>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene la lista de Entradas.</returns>
        ...
        /// <summary>
        /// Busca una Entrada por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID de la Entrada.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene la Entrada encontrada.</returns>
        ...
        /// <summary>
        /// Obtiene los detalles de una Entrada por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID de la Entrada.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene los detalles de la Entrada.</returns>
        ...
        /// <summary>
        /// Agrega una nueva Entrada de forma as�ncrona.
        /// </summary>
        /// <param name="model">El modelo de la Entrada a agregar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se agreg� la Entrada correctamente.</returns>
        public async Task<Boolean> AddAsync(EntradaViewModel model, int userId)
        {
            try
            {
                tbEntradas mappedResult = _mapper.Map<tbEntradas>(model);
                mappedResult.ent_UsuarioCrea = userId;
                mappedResult.ent_FechaCrea = DateTime.Now;
        ...
        /// <summary>
        /// Actualiza una Entrada existente de forma as�ncrona.
        /// </summary>
        /// <param name="model">El modelo de la Entrada a actualizar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se actualiz� la Entrada correctamente.</returns>
        public async Task<Boolean> UpdateAsync(EntradaViewModel model, int userId)
        {
            try
            {
                tbEntradas mappedResult = _mapper.Map<tbEntradas>(model);
                mappedResult.ent_UsuarioModifica = userId;
                mappedResult.ent_FechaModifica = DateTime.Now;
        ...
        /// <summary>
        /// Elimina una Entrada por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID de la Entrada a eliminar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se elimin� la Entrada correctamente.</returns>

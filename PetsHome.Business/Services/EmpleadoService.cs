...
namespace PetsHome.Business.Services
{
    ...
    public class EmpleadoService
    {
        ...
        /// <summary>
        /// Obtiene una lista de Empleados de forma as�ncrona.
        /// </summary>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene la lista de Empleados.</returns>
        ...
        /// <summary>
        /// Busca un Empleado por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID del Empleado.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene el Empleado encontrado.</returns>
        ...
        /// <summary>
        /// Obtiene los detalles de un Empleado por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID del Empleado.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene los detalles del Empleado.</returns>
        ...
        /// <summary>
        /// Agrega un nuevo Empleado de forma as�ncrona.
        /// </summary>
        /// <param name="model">El modelo del Empleado a agregar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se agreg� el Empleado correctamente.</returns>
        public async Task<Boolean> AddAsync(EmpleadoViewModel model, int userId)
        {
            try
            {
        ...
        /// <summary>
        /// Actualiza un Empleado de forma as�ncrona.
        /// </summary>
        /// <param name="model">El modelo del Empleado a actualizar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se actualiz� el Empleado correctamente.</returns>
        public async Task<Boolean> UpdateAsync(EmpleadoViewModel model, int userId)
        {
            try
            {
                tbEmpleados mappedResult = _mapper.Map<tbEmpleados>(model);
        ...
        /// <summary>
        /// Elimina un Empleado por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID del Empleado a eliminar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se elimin� el Empleado correctamente.</returns>
        ...
        /// <summary>
        /// Obtiene una lista de opciones de cargo de empleados de forma as�ncrona.
        /// </summary>
        /// <returns>Una enumeraci�n de las opciones de cargo de empleados.</returns>

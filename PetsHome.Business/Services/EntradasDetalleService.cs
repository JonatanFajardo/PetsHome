...
namespace PetsHome.Business.Services
{
    ...
    public class EntradasDetalleService
    {
        ...
        /// <summary>
        /// Obtiene una lista de Detalles de Entradas por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID de la Entrada.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene la lista de Detalles de Entradas.</returns>
        ...
        /// <summary>
        /// Busca un Detalle de Entrada por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID del Detalle de Entrada.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene el Detalle de Entrada encontrado.</returns>
        ...
        /// <summary>
        /// Agrega un nuevo Detalle de Entrada de forma as�ncrona.
        /// </summary>
        /// <param name="model">El modelo del Detalle de Entrada a agregar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se agreg� el Detalle de Entrada correctamente.</returns>
        ...
        /// <summary>
        /// Actualiza un Detalle de Entrada de forma as�ncrona.
        /// </summary>
        /// <param name="model">El modelo del Detalle de Entrada a actualizar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se actualiz� el Detalle de Entrada correctamente.</returns>
        ...
        /// <summary>
        /// Elimina un Detalle de Entrada por su ID de forma as�ncrona.
        /// </summary>
        /// <param name="id">El ID del Detalle de Entrada a eliminar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se elimin� el Detalle de Entrada correctamente.</returns>

...
namespace PetsHome.Business.Services
{
    ...
    public class EventoService
    {
        ...
        /// <returns>True si el evento se agreg� correctamente, False si ocurri� un error.</returns>
        ...
        /// <returns>True si el evento se actualiz� correctamente, False si ocurri� un error.</returns>
        ...
        /// <returns>True si el evento se elimin� correctamente, False si ocurri� un error.</returns>

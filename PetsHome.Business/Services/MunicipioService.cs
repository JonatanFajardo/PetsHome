...
namespace PetsHome.Business.Services
{
    ...
    public class MunicipioService
    {
        ...
        /// <returns>True si el municipio se agreg� correctamente, False si ocurri� un error.</returns>
        public async Task<bool> AddAsync(MunicipioViewModel model, int userId)
        {
            try
            {
        ...
        /// <returns>True si el municipio se actualiz� correctamente, False si ocurri� un error.</returns>
        public async Task<bool> UpdateAsync(MunicipioViewModel model, int userId)
        {
            try
            {
                tbMunicipios mappedResult = _mapper.Map<tbMunicipios>(model);

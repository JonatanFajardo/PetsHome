...

{
...

    {
        ...
        /// <summary>
        /// Obtiene una lista de EmpleadosCargo de forma as�ncrona.
        /// </summary>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene la lista de EmpleadosCargo.</returns>
        ...
        /// <summary>
        /// Busca un EmpleadoCargo por su ID de forma as�ncrona.
        /// </summary>

        /// <param name="id">El ID del EmpleadoCargo.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene el EmpleadoCargo encontrado.</returns>
        ...
        /// <summary>
        /// Obtiene los detalles de un EmpleadoCargo por su ID de forma as�ncrona.
        /// </summary>

        /// <param name="id">El ID del EmpleadoCargo.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado contiene los detalles del EmpleadoCargo.</returns>
        ...
        /// <summary>
        /// Agrega un nuevo EmpleadoCargo de forma as�ncrona.
        /// </summary>

        /// <param name="model">El modelo del EmpleadoCargo a agregar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se agreg� el EmpleadoCargo correctamente.</returns>
        public async Task<Boolean> AddAsync(EmpleadoCargoViewModel model, int userId)
        {
...

            {
                ...
                mappedResult.cag_UsuarioCrea = userId;
        ...
        /// <summary>
        /// Actualiza un EmpleadoCargo de forma as�ncrona.
        /// </summary>

        /// <param name="model">El modelo del EmpleadoCargo a actualizar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se actualiz� el EmpleadoCargo correctamente.</returns>
        public async Task<Boolean> UpdateAsync(EmpleadoCargoViewModel model, int userId)
        {
...

            {
                ...
                mappedResult.cag_UsuarioModifica = userId;
        ...
        /// <summary>
        /// Elimina un EmpleadoCargo por su ID de forma as�ncrona.
        /// </summary>

        /// <param name="id">El ID del EmpleadoCargo a eliminar.</param>
        /// <returns>Una tarea que representa la operaci�n asincr�nica. El resultado indica si se elimin� el EmpleadoCargo correctamente.</returns>
